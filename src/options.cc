...
Options::usage (void)
{
  ...
  report_error ("\nUsage: %n [-acCdDef[num]gGhH<hashname>i<init>jk<keys>K<keyname>l\n"
		"\tL<language>nN<function name>oprs<size>S<switches>tTvZ<class name>]\n\n"
                "(type %n -h for help)\n");
}
        ...
        case 'h':               /* Displays a list of helpful Options to the user. */
          {
            report_error ("%e\n"
                          ...
                          "-K\tAllow use to select name of the keyword component in the\n"
			  "\tkeyword structure.\n"
                          ...
                          "-n\tDo not include the keyword length when computing the hash function\n"
                          ...
                          "\tkeys, e.g. a value of 3 means ``allow the maximum associated value to\n"
                          "\tbe about 3 times larger than the number of input keys.''  Conversely,\n"
                          "\ta value of -3 means ``make the maximum associated value about 3 times\n"
			  "\tsmaller than the number of input keys.\n"
                          "\tA larger table should decrease the time required for an unsuccessful\n"
                          "\tsearch, at the expense of extra table space.  Default value is 1.\n"
                          "-S\tCauses the generated C code to use a switch statement scheme, rather\n"
                          "\tthan an array lookup table.  This can lead to a reduction in both\n"
                          "\ttime and space requirements for some keyfiles.  The argument to\n"
                          "\tthis option determines how many switch statements are generated.\n"
                          "\tA value of 1 generates 1 switch containing all the elements, a value of\n"
                          "\t2 generates 2 tables with 1/2 the elements in each table, etc.  This\n"
                          ...
                          "\tname is `Perfect_Hash.'\n%a", usage, DEFAULT_JUMP_VALUE, (MAX_KEY_POS - 1), 1);
          }
